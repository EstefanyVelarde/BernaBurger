...
<body>
  <?php $page='ordenes'; include 'includes/navbar.php'; ?>
    ...
    <div class="container-fluid text-uppercase row">
      ...
      <div class="tab-content tabz" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="v-pills-add" role="tabpanel" aria-labelledby="v-pills-add-tab">
          ...
          <div class="ml-4" id="agregarOrden"></div>

        </div>

        <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
          <div class="container-fluid p-2">
            <div class="m-3" id="tablaOrdenes"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <?php include 'modalAddOrden.php'; ?>
  <?php include 'modalInfoOrden.php'; ?>
